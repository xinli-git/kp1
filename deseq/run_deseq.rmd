...
library("readr")
<<<<<<< HEAD
files <- file.path(dir, "rsem", "rsem_output", paste0(samples$run, ".Aligned.toTranscriptome.genes.results"))
names(files) <- paste0("sample", 1:21)
=======
files <- file.path(dir, "rsem", "rsem_output", samples$rna_lib, ".Aligned.toTranscriptome.genes.results")
names(files) <- paste0("sample", 1:6)
>>>>>>> ffb76ca53266b735242a815cf97af9cfedc3f0ca
