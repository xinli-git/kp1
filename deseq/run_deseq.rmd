...
temp <- atlas_design[, c('group', 'comparison', 'sample')]
colnames(temp) <- c('tissue', 'condition', 'rna_lib')
merged_design <- rbind(samples[, c('tissue', 'condition', 'rna_lib')], temp[, c('tissue', 'condition', 'rna_lib')])
