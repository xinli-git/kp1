...
### pcaExplorer, need browser interface
...
report2 <- HTMLReport(shortName = 'kp1, RNAseq_analysis_with_DESeq2',
	title = 'kp1, RNA-seq analysis of differential expression using DESeq2',
	reportDirectory = dir_deseq)
publish(ddsTxi, report2, pvalueCutoff=0.05,
...
```
https://xinli-git.github.io/kp1_supp/deseq/kp1_deseq_index.html
